...
const Card = ({ img, name, username, desc, link }) => {
    return (
        <div className='w-full h-auto flex items-center justify-center flex-col space-y-6 rounded-xl p-6 backdrop-blur-md border border-neutral-200/60 bg-neutral-50/25'>
